  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="opacity-0 group-hover:opacity-100 focus-visible:opacity-100 flex w-7 h-7 rounded-full items-center justify-center cursor-pointer hover:bg-white/10 transition-opacity"
